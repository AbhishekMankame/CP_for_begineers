...
/*You are given an integer array `nums` consisting of `2*n` integer.
...
Input: nums = [1,2,3,4]
Output: false
Explanation: There is no way to divide nums into 4/2=2 pairs such that one pair satisfy every condition.
